...
const Header = () => {
  ...
  return (
    <header className="bg-white shadow-md py-3 px-6 sticky top-0 z-50">
      {/* 🔴 ONLY responsive change is here */}
      <div className="max-w-[1280px] mx-auto flex flex-col md:flex-row md:items-center md:justify-between relative">
        {/* Logo */}
        <Link to="/" className="text-pink-600 font-bold text-2xl tracking-wide">
          IDEACRAFT
        </Link>
        ...
        {/* 🔍 Search with Suggestions */}
        {/* 🔴 Mobile: next row | Desktop: same */}
        <div className="w-full md:w-1/2 relative mt-3 md:mt-0">
          <input
            type="text"
            value={searchTerm}
            onChange={(e) => {
        ...
        {/* Icons */}
        <div className="flex items-center gap-6 text-gray-600 text-xl relative mt-3 md:mt-0">
          {/* Wishlist */}
